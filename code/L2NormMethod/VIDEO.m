...
%dirpath=strcat(basepath,'/8647/Projection_8647_Td2_GaussainNoise_percent_10/Result/rmvNoise_BM3D_proj502_soff10_iter20');
%dirpath=strcat(basepath,'/8647/Projection_8647_Td2/Result/proj500_soff10_iter20');
...
% EM-4138
dirpath=strcat(basepath,'/4138/Projection_4138_Crp86_GaussainNoise_percent_100/Result/rmvNoise_BM3D_proj503_soff10_iter5');

%dirpath=strcat(basepath,'/4138/Projection_4138_Crp86/Result/proj500_soff10_iter20');
...
for i=1:N      
    ...
    imshow(initReconstObj(:,:,i),[0 maxTrue]),colorbar;    
