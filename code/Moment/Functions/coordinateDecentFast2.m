...
function [R_final,Im_final,An_final,error,iteration,ithError]=coordinateDecentFast2(projMoment,R_init,searchArea,momentOrder,maxIteration,config)
    ...
    %% Init     
     ...
     Im_init=allCentralMoment3D(G,momentOrder);
     An_int= mergeBigA(bigA,momentOrder);
    ...
    for i=1:maxIteration
         ...
         Im_est=allCentralMoment3D(G,momentOrder);
         An = mergeBigA(bigA_est,momentOrder);
